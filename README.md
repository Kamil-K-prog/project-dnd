# Проект заморожен:
1) Я на стажировке, времени на проект не так много
2) Сейчас я работаю над отдельным ядром на Python. Заглядывайте в [AI_chat](https://github.com/Kamil-K-prog/AI_chat)
3) Я слишком опирался на ИИ (*эх, Gemini 1.5 Pro...*), и из пет-проекта код превратился в "вайб-проект", что мне не по душе

# Будущее проекта
После того, как я закончу работу над ядром [AI_chat](https://github.com/Kamil-K-prog/AI_chat), я буду переписывать проект на актуальную версию Laravel.

Структура БД неплохая, но сейчас она скорее путает, это тоже будет исправлено

# Игровая платформа для D&D
