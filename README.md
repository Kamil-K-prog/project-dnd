# ПРОЕКТ ЗАБРОШЕН ПО СЛЕДУЮЩИМ ПРИЧИНАМ:
1) У меня учёба, из-за которой я пока не могу писать код
2) В процессе написания кода здесь я использовал нейросеть слишком часто. Проект задумывался как место, где я отточу свои навыки, приобрету новые знания и покажу их миру, а в итоге я просто смотрел, как работа совершается за меня

# Будущее проекта
Как появится свободное время, в планах возродить проект, лучше его структурировать, и начать писать заново, уже самостоятельно.

Структура БД неплохая, но сейчас она скорее путает, это тоже будет исправлено
...
Нейросеть я использую для трёх вещей:
 1) Фронтенд - потому что я плохо верстаю, а моё обучение Vue только на начальной стадии
...
## Предполагаемый функционал
 - Регистрация/авторизация (С помощью Breeze ✅)
 - Система друзей (добавление по коду) ✅
...
Для начала, игру будет вести человек. После того, как всё будет готово, будет интегрирован ИИ для:
 ...
 - **Главное** - автономное ведение игры (ИИ как мастер игры)
